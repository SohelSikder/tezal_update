...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'is_admin', 'en.locale'], 'as' => 'admin.'], function () {
    ...
    Route::group(['prefix' => 'category'], function () {
        ...
        Route::get('/subCatcreate', [CategoryController::class, 'subCategoryCreate'])->name('category.sub.create')->middleware(['permission:category-create']);
    ...
    Route::group(['prefix' => 'product'], function () {
        ...
        Route::get('/physical/ProductCsvUpload', [ProductController::class, 'physicalProductCsvUpload'])->name('physical.ProductCsvUpload')->middleware(['permission:product-import']);
        Route::post('/physical/product_import', [ProductController::class, 'physicalProductImport'])->name('physical.product_import')->middleware(['permission:product-import']);

        Route::get('/physical/create/sub_cat_data', [ProductController::class, 'sub_cat_data'])->name('physical.product.create.sub_cat_data')->middleware(['permission:product-create']);
        Route::get('/physical/create/sub_sub_cat_data', [ProductController::class, 'sub_sub_cat_data'])->name('physical.product.create.sub_sub_cat_data')->middleware(['permission:product-create']);
    ...
    Route::group(['prefix' => 'today-story'], function () {
        ...
        Route::post('/update', [StoryController::class, 'update'])->name('story.update');
        Route::get('/delete/{id}', [StoryController::class, 'delete'])->name('story.delete');
        Route::get('/status/{id}', [StoryController::class, 'status'])->name('story.status');
    ...
    Route::get('/address-list',[UserController::class, 'addressList'])->name('address_list');
