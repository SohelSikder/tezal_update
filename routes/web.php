...
Route::post('/submit-location', [HomeController::class, 'submitLocation'])->name('submit.location');

Route::get('/get-area/{id}', function ($id){


    return json_encode(DB::table('areas')->where('district_id', $id)->get());


})->name('area');

// Route::get('/get-area', function ($id){
//     // return $id;
//     $output=['id'=>$id];
...
Route::group(['middleware' => ['is_user']], function () {
    ...
    Route::get ('/subcategoryView', [HomeController::class, 'subCategoryView'])->name('subCategroyView');
    ...
    Route::group(['prefix' => 'product'], function () {
        ...
        Route::get('subsubcategorydata/{id}', [ProductController::class, 'subsubcategory'])->name('subsubcategoriess');
        ...
        Route::get('new_arrival', [ProductController::class, 'newArrival'])->name('newArrival.product');
        Route::get('bestSelling', [ProductController::class, 'bestSelling'])->name('bestSelling.product');

        Route::get('subCatView/{id}', [ProductController::class, 'CategoryWiseProduct'])->name('subCatView');
        Route::get('onSale', [ProductController::class, 'onSale'])->name('onSale.product');
        Route::get('featured', [ProductController::class, 'featured'])->name('featured.product');
    });
