    ...
    public function socialLink(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->editColumn('youtube', function ($data) {
                    if ($data->Facebook) {
                        $btn = '<a href="' . $data->youtube . '" target= _blank class="btn btn-success small">YouTube</a>';
                        return $btn;
                    } else {
                        $btn = '<a href="' . $data->youtube . '" target= _blank class="btn btn-success small disabled">YouTube</a>';
                        return $btn;
                    }
                })
                ...
                ->rawColumns(['action', 'Facebook', 'youtube', 'Skype', 'Twitter', 'Linkedin', 'Instagram'])
                ->make(true);
        }
