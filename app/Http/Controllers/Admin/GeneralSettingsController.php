...
class GeneralSettingsController extends Controller
{
    ...
    public function updateSettings(Request $request)
    {
        try {
			...
			if (isset($request->header_top_color)) {
                Setting::where('slug', 'header_top_color')->update(['value' => $request->header_top_color]);
            }
			if (isset($request->header_top_border_color)) {
                Setting::where('slug', 'header_top_border_color')->update(['value' => $request->header_top_border_color]);
            }
			if (isset($request->header_mid_color)) {
                Setting::where('slug', 'header_mid_color')->update(['value' => $request->header_mid_color]);
            }if (isset($request->header_bottom_color)) {
                Setting::where('slug', 'header_bottom_color')->update(['value' => $request->header_bottom_color]);
            }if (isset($request->Add_to_cart_color)) {
                Setting::where('slug', 'Add_to_cart_color')->update(['value' => $request->Add_to_cart_color]);
            }
            ...
            if (isset($request->code_head)) {
                Setting::where('slug', 'code_head')->update(['value' => $request->code_head]);
            }
            if (isset($request->code_body)) {
                Setting::where('slug', 'code_body')->update(['value' => $request->code_body]);
            }
            if (isset($request->code_footer)) {
                Setting::where('slug', 'code_footer')->update(['value' => $request->code_footer]);
            }
