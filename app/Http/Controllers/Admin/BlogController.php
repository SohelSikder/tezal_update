...
class BlogController extends Controller
{
    ...
    public function blogStore(BlogRequest $request)
    {
        ...
        $blog = Blog::create([
            ...
            'en_Description_One' => $request->en_description_one ?? null,
            'en_Description_Two' => $request->en_description_two ?? null,
            'Small_Image' => $small_image,
            'Big_Image' => $big_image,

            'fr_Title' => $request->fr_blog_title?? null,
            'fr_Description_One' => $request->fr_description_one ?? null,
            'fr_Description_Two' => $request->fr_description_two ?? null,
            'user_id' => Auth::id(),
        ]);
        if ($blog) {
            Tag::create([
