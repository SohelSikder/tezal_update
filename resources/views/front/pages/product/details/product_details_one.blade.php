                        ...
                        <div class="product-single-right">
                            <div class="product-info">
                                ...
                                <div class="product-bottom-button d-flex">
                                    <a href="javascript:void(0)" class="add-cart addCart"
                            ...
                            <div class="product-right-bottom">
                                <ul class="features">
                                    <li class="single-feature"><img class="icon"
                                        ...
                                        @php
                                            $charge_dhaka = DB::table("delivery_charges")->where('country', 'Inside Dhaka')->first();
                                            $charge_outside = DB::table("delivery_charges")->where('country', 'Outside Dhaka')->first();
                                        @endphp
                                    <li class="single-feature"><img class="icon"
                                            ...
                                            <span
                                            class="feature-text">{{ __('Inside Dhaka') }} {{ $charge_dhaka->charge }}, {{ __('Outside Dhaka') }} {{ $charge_outside->charge }} </span>
                    ...
                    <div class="col-lg-3 col-md-4 col-6 col-sm-6">
                        <div class="single-grid-product">
                            ...
                            <div class="product-info text-center">
                                ...
                                <!--    <h4 class="product-catagory">{{ $ppt->tag }}</h4>-->
                                <!--@endforeach-->
                                <h3 class="product-name" style="overflow: hidden;text-overflow: ellipsis;">
                                    <a class="product-link"
                                        href="{{ route('single.product', $product->en_Product_Slug) }}" title="{{ langConverter($product->en_Product_Name, $product->fr_Product_Name) }}">{{ langConverter($product->en_Product_Name, $product->fr_Product_Name) }}</a>
                                </h3>
                                <!-- This is server side code. User can not modify it. -->
