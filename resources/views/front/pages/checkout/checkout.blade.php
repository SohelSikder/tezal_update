                            ...
                            <form method="post" {{-- action="{{ auth()->check() ? route('checkout.order') : route('guest.checkout.order') }}" --}} action="{{ route('checkout.order') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="billing_number" name="billing_number"
                                                placeholder="{{ __('আপনার মোবাইল নম্বর') }}"
                                                value="{{ isset($billing) ? $billing->Number ?? $billing->number : '' }}"
                                                required />
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input type="email" class="form-control" id="billing_email"
                                                name="billing_email" placeholder="{{ __('ইমেইল এড্রেস') }}"
                                    ...
                                    <div class="col-lg-6 form-group" style="margin-top:10px;">
                                        <label for="message-text" class="col-form-label">{{__('জেলা')}}</label>
                                        ...
                                        <select name="district_id" id="district" class="form-control form-control-solid bg-light form-control-lg signin-signup-input @error('district_id') is-invalid @enderror" required>
                                    ...
                                    <div class="col-lg-6 form-group" style="margin-top:10px;">
                                        <label for="message-text" class="col-form-label">{{__('এলাকা')}}</label>
                                        <!--<select class="form-control form-control-solid bg-light form-control-lg signin-signup-input  " id="addressTitleSelect" name="address_title"><option disabled="">ঠিকানার শিরোনাম</option><option value="Home">Home</option><option value="Work">Work</option><option value="Other">Others</option></select>-->
                                        
                                        <select name="area_id" id="areass" class="form-control form-control-solid bg-light form-control-lg signin-signup-input @error('area_id') is-invalid @enderror" required>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="billing_street_address"
                                                name="billing_street_address" placeholder="{{ __(' আপনার ঠিকানা
') }}"
                                    ...
                                    {{--<div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="billing_state"
                                                ...
                                                value="{{ isset($billing) ? $billing->State : '' }}"  />
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="billing_zipcode"
                                                ...
                                                value="{{ isset($billing) ? $billing->Zipcode : '' }}"  />
                                        </div>
                                    </div>--}}
                                    ...
                                    <div class="col-lg-12">
                                        <select class="form-select" id="billing_country" name="billing_country" >
                                            <option>{{ __('ডেলিভারি এরিয়া') }}</option>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="shipping_number"
                                                name="shipping_number" placeholder="{{ __('You Phone Number') }}"
                                                value="" />
                                ...
                                <div class="payment-method">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <!--            <a href="https://shop.bkash.com/tezal-dot-com-dot-bdrm56719/paymentlink/default-payment" ><label class="form-check-label btn btn-danger text-light" > Pay with bKash </label></a>-->
                                            ...
                                            <!--        </div>-->
                                            <!--    </div>-->
                                            <!--<a href="https://shop.bkash.com/tezal-dot-com-dot-bdrm56719/paymentlink/default-payment" class="btn btn-danger" target="_blank">Pay with Bkash</a>-->
                                         <!--   @foreach ($paymentPlatforms as $payment)
                                            ...
                                            @endforeach -->
                                                ...
                                                <div class="form-group d-none">
                                                    <div class="form-check card-check">
                                                        <input checked="checked" class="form-check-input" type="radio" name="payment"
                                                            id="COD" value="COD"  />
                                                        <label class="form-check-label"
                                            ...
                                            <div class="col-lg-12">
                                            <h2 class="checkout-title">{{ __('অর্ডার কন্ফার্ম করার জন্য ডেলিভারি চার্জ পেমেন্ট করুন') }}</h2>
											<h3 class="checkout-title">{{ __('bKash / Nagad : 01766985858') }}</h3>
											<!-- <h3 class="checkout-title">{{ __('Nagad : 01766985858') }}</h3>-->
                                        </div>
