                                ...
                                <div class="col-md-6">
                                    <div class="form-vertical__item bg-style">
                                        ...
                                        <form enctype="multipart/form-data" method="POST"
											...
											<div class=" mb-25">
                                                <label for="title" class="text-dark mb-2">{{ __('Header Top Color') }}</label>
                                                <input type="color" class="form-control" id="header_top_color"
                                                    name="header_top_color" value="{{ $allsettings['header_top_color'] }}"
                                                    required="">
                                            </div>
											<div class="mb-25">
                                                <label class="text-dark mb-2" for="title">{{ __('Header Top Border Color') }}</label>
                                                <input type="color" class="form-control" id="header_top_border_color"
                                                    name="header_top_border_color" value="{{ $allsettings['header_top_border_color'] }}"
                                                    required="">
                                            </div>
											<div class="mb-25">
                                                <label class="text-dark mb-2" for="title">{{ __('Header Mid Color') }}</label>
                                                <input type="color" class="form-control" id="header_mid_color"
                                                    name="header_mid_color"value="{{ $allsettings['header_mid_color'] }}"
                                                    required="">
                                            </div>
											<div class="mb-25">

												<label for="title" class="text-dark mb-2">{{ __('Header bottom Color') }}</label>

                                                <input type="color"  class="form-control" id="header_bottom_color"
                                                    name="header_bottom_color" value="{{ $allsettings['header_bottom_color'] }}"
                                                    required="">
                                            </div>
                                            <div class="mb-25">

												<label for="title" class="text-dark mb-2">{{ __('Add To Cart bottom Color') }}</label>

                                                <input type="color"  class="form-control" id="Add_to_cart_color"
                                                    name="Add_to_cart_color" value="{{ $allsettings['Add_to_cart_color'] }}"
                                                    required="">
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-vertical__item bg-style">
                                        ...
                                        <form enctype="multipart/form-data" method="POST"
                                            ...
                                            <div class="input__group mb-25">
                                                <label for="">{{ __('Header Code') }}</label>
                                                <textarea name="code_head"  class="form-control putImage6" id="code_head"
                                                 cols="30" rows="10">{{ $allsettings['code_head'] }}</textarea>

                                            </div>

                                            <div class="input__group mb-25">
                                                <label for="">{{ __('Body Code') }}</label>
                                                <textarea name="code_body" class="form-control putImage6" id="code_body"
                                                 cols="30" rows="10">{{ $allsettings['code_body'] }}</textarea>

                                            </div>
                                            <div class="input__group mb-25">
                                                <label for="">{{ __('Footer Code') }}</label>
                                                <textarea name="code_footer" class="form-control putImage6" id="code_footer"
                                                 cols="30" rows="10">{{ $allsettings['code_footer'] }}</textarea>
