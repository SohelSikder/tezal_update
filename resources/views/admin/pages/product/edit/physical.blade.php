                                        ...
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                               ...
                                               {{-- <select class="form-control" id="en_category_name" name="en_category_name">
                                                 ...
                                                 <select class="form-control" id="category" name="en_category_name" onclick="subCategory()">
                                                      @php
                                                    ...
                                                    @foreach ($categories as $category)
                                                        ...
                                                        @if (count($subcategories) > 0)
                                                            @foreach ($subcategories as $subCategory)
                                                                <option value="{{ $subCategory->id }}" {{ $subCategory->id == $product->Category_Id ? 'selected' : '' }}>-->{{ $subCategory->en_Category_Name }}</option>
                                                                @php
                                                                    $sub_subCategories = App\Models\Admin\Category::where('parent_id', $subCategory->id)->get();
                                                                @endphp
                                                                @if (count($sub_subCategories) > 0)
                                                                    @foreach ($sub_subCategories as $subSubCategory)
                                                                        <option value="{{ $subSubCategory->id }}" {{ $subSubCategory->id == $product->Category_Id ? 'selected' : '' }}>--->{{ $subSubCategory->en_Category_Name }}</option>
                                                                        @php
                                                                        ...
                                                                        @if (count($sub_sub_sub_categories) > 0)
                                                                            @foreach ($sub_sub_sub_categories as $subsubsubCategory)
                                                                                <option value="{{ $subsubsubCategory->id }}" {{ $subsubsubCategory->id == $product->Category_Id ? 'selected' : '' }}>------>{{ $subsubsubCategory->en_Category_Name }}</option>
                                                                            @endforeach
                                                                        @endif
                                                                    @endforeach
                                                                @endif
