                                    ...
                                    <div class="col-md-12">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                <label for="en-product-name">{{ __('Product Name') }} @required</label>
                                                <input required type="text" class="form-control" id="en-product-name"
                                            ...
                                            <div class="input__group mb-25">
                                                <label for="en-product-slug">{{ __('Product Slug') }} @required</label>
                                                <input required type="text" class="form-control" id="en-product-slug"
                                            ...
                                            <div class="input__group mb-25" style="display: none;">
                                                ...
                                                <select class="form-control" id="en_brand_name" name="en_brand_name">
                                                    ...
                                                    @foreach (Brnad() as $item)
                                                        <option value="1">{{ $item->en_BrandName }}</option>
                                                    @endforeach
                                                </select>
                                                @error('en_brand_name')
                                                    <span class="text-danger">{{ $message }}</span>
                                            ...
                                            <div class="input__group mb-25">
                                                <label for="price">{{ __('Price') }} @required</label>
                                                <input required type="number" min="0" class="form-control" id="price"
                                            ...
                                            <div class="input__group mb-25">
                                                <label for="primary_image">{{ __('Primary Image') }} @required</label>
                                                <input required type="file" class="form-control putImage1" name="primary_image"
                                                    id="primary_image">
                                                <img src="" id="target1" />
                                            ...
                                            <div class="input__group mb-25">
                                                <div class="custom-control custom-switch">
                                                    <input checked type="checkbox" value="1" name="on_sale"
                                  ...
                                  <!--  <div class="col-md-6">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                             ...
                                             <div class="input__group mb-25">
                                                <label for="qty">{{ __('Quantity') }}</label>
                                                <input type="text" class="form-control" id="qty" name="fr_qty"
                                                    value="{{ old('fr_qty') }}" placeholder="Quantity">
                                                @error('fr_qty')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
