                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <div class="input__group mb-25">
                                                <label for="background_image">{{ __('Slider Image Mobile') }}</label>
                                                <input type="file" class="putImage3" name="background_image_mobile"
                                                    id="background_image_mobile">
                                                <img class="admin_image"
                                                    src="{{ asset(SliderImage() . $edit->background_image_mobile) }}"
                                                    id="target3" />
                                            </div>
                                            <div class="input__group mb-25">
