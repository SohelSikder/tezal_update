                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-vertical__item bg-style">
                                            ...
                                            <!--</div>-->
                                            <div class="input__group mb-25">
                                                <label for="background_image">{{ __('Slider Image') }} (1900x500)</label>
                                                <input type="file" class="form-control putImage2" name="background_image"
                                                    id="background_image">
                                                <img src="" id="target2" />
                                            </div>
                                            <div class="input__group mb-25">
                                                <label for="background_image">{{ __('Mobile Slider') }}</label>
                                                <input type="file" class="form-control putImage3" name="background_image_mobile"
                                                    id="background_image_mobile">
                                                <img src="" id="target3" />
                                            </div>
                                            <div class="input__group mb-25">
                                                <label for="en_sub_title">{{ __('Link ') }}</label>
