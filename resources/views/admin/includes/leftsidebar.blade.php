...
<div class="sidebar__area">
    ...
    <div class="sidebar__brand">
        <a href="{{ route('admin.dashboard') }}">
            <img src="{{ asset(IMG_LOGO_PATH . $allsettings['footer_logo']) }}" alt="icon" height="50" class="round">
        </a>
    </div>
    <ul id="sidebar-menu" class="sidebar__menu">
        ...
        @canany(['product-list'])
            <li class="{{ isset($menu) && $menu == 'products' ? 'mm-active' : '' }}">
				...
				{{-- <li class="{{ isset($submenu) && $submenu == 'product.ProductCsvUpload' ? 'mm-active' : '' }}">
                        <a href="{{ route('admin.physical.ProductCsvUpload') }}">
                            <i class="fa fa-circle"></i>
                            <span>{{ __('Product Bulk Upload') }}</span>
                        </a>
                </li> --}}
        ...
        @canany(['user-list'])
            <li class="{{ isset($menu) && $menu == 'users' ? 'mm-active' : '' }}">
                ...
                <ul>
                    ...
                    <li class="{{ isset($submenu) && $submenu == 'address_list' ? 'mm-active' : '' }}">
