            ...
            <div class="col-xl-6 col-lg-8 col-md-10">
                <div class="authentication__item">
                    <div class="authentication__item__logo">
                        <a href="{{route('front')}}">
                            <img style="height:70px;width:250px; margin-left:85px;" src="{{asset(IMG_LOGO_PATH.$allsettings['main_logo'])}}" alt="icon">
                        </a>
                    </div>
                        ...
                        <form action="{{ route('login.post') }}" method="post">
                            ...
                            <div class="input__group mb-25">
                                ...
                                <div class="input-overlay">
                                    <input type="text" name="email" id="email" value="" placeholder="{{__('Enter email address')}}">
                                    <div class="overlay">
                            ...
                            <div class="input__group mb-20">
                                ...
                                <div class="input-overlay">
                                    <input type="password" name="password" id="pass" value="" placeholder="{{__('Enter password')}}">
                                    <div class="overlay">
